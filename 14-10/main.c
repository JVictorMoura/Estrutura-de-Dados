...
int main()
{
    Tarefa T = {"Preparar relatorio da disciplina RT", "Ana Maria", EM_ANDAMENTO, 0.75, 5};
    ...
    Lista * Planner = CriarLista(12);
 
    printf ("%d\n", Planner);
    AdicionarTarefa (Planner, T);
...
void GerarHTMLTabela(Planner, Lista.html)
